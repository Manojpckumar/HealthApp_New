...
import com.manojpc.healthcareapp.adapter.ConsultationFragmentAdapter;
...
public class DossierMedical extends AppCompatActivity {
    ...
    private Button createNewFicheButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNewFicheButton = (Button) findViewById(R.id.floatingActionButton);
