...
public class HomeActivity extends AppCompatActivity {
    ...
    Button BtnRequst;
    Button profile;
    Button appointment,btnHealthTips,btnBlogpost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBlogpost = (Button)findViewById(R.id.btnBlogPost);
        ...
        btnHealthTips.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent k = new Intent(HomeActivity.this, HealthTipActivity.class);
                startActivity(k);
        ...
        btnBlogpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent k = new Intent(HomeActivity.this, BlogActivity.class);
                startActivity(k);
